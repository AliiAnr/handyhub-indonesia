...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Card Managemen Tukang -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="/admin-tukang" style="text-decoration: none;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Managemen User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Managemen Tukang</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Managemen User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Managemen Customer</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-users fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <!-- Card Pelayanan -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="/pelayanan" style="text-decoration: none;">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Pelayanan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Managemen Pelayanan</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Testimoni</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Daftar Testimoni</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Riwayat</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Daftar Riwayat</div>
                                        </div>
                                        <div class="col-auto">
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="logoutModal" tabadmin="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
