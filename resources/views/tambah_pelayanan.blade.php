                    ...
                    <div class="card shadow mb-4">
                     <div class="card-body">
                       <div class="card-inside">
                         <h1 class="card-title">Tambah Data Pelayanan</h1>
                         <form id="tambah-customer-form" enctype="multipart/form-data" action="/pelayananbaru" method="POST">
                            @csrf
                           <div class="form-group">
                             <label for="pelayanan">Pelayanan:</label>
                             <select id="pelayanan" name="Kategori" class="form-control" required>
                           ...
                           <div class="form-group">
                             ...
                             <input type="text" id="kategori" name="JenisPelayanan" class="form-control" required>
                           </div>
                           <div class="form-group">
